      ...
      <div className="max-w-7xl mx-auto">
            ...
            {features.map((feature, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-[#FFC107] bg-opacity-20 rounded-lg flex items-center justify-center text-[#28A745]">
                    {feature.icon}
                  </div>
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="text-3xl font-bold font-poppins text-[#28A745] mb-2">
                {stat.value}
              </div>
